...
// Function to generate legal moves int 64 bit form for a given player
...
// function to check for game over, 0 means there is a legal move, 1 means game over, 2 means pass
